      ...
      <figure className="max-w-96 my-1 rounded-lg mx-auto">
        ...
        <section className="bg-[#E8E6E7] pb-10">
          <img
            ...
            alt="asesor"
          />
          <h3 className="text-2xl font-bold border-b-2 border-gray-500 text-center mx-10 mt-5">
            {asesor.name}
          </h3>
          <p className="text-center text-gray-500 text-base mt">
        ...
        <section className="mt-5 flex justify-around">
          <div className="cursor-pointer">
            ...
            <p className="text-gray-500 text-center mt-3 text-base font-bold">
              Llamar
            </p>
          </div>
          <div className="cursor-pointer">
