...
const CardProducts = () => {
    ...
    return (
        <div onClick={() => navigate('/store/product/1')} className="transition duration-500 w-80 border rounded-lg relative cursor-pointer hover:border-[#E2060F] sm:w-64 xl:w-80">
            <div>
