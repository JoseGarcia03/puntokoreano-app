...
const FilterStore = () => {
  ...
  const transmissions: Record<string, any> = {
    ssangyong: {
      ...
      "2006": {
        ...
        stavic: [{ label: "MEC 4x4", value: "mec_4x4" }],
        kyron: [
          { label: "MEC 4x4", value: "mec_4x4" },
          { label: "AUT 4X4", value: "aut_4x4" },
        ],
      ...
      "2007": {
        ...
        actyon_sports: [{ label: "MEC 4X4", value: "mec_4x4" }],
      },
      "2008": {
        rexton: [
          { label: "MEC 4X4", value: "mec_4x4" },
      ...
      "2010": {
        ...
        stavic: [{ label: "AUT 4X4", value: "aut_4x4" }],
        kyron: [
      ...
      "2015": {
        kyron: [{ label: "MEC 4X2", value: "mec_4x2" }],
        actyon: [
          { label: "MEC 4X2", value: "mec_4x2" },
          { label: "MEC 4X4", value: "mec_4x4" },
          { label: "AUT 4X2", value: "aut_4x2" },
      ...
      "2016": {
        ...
        new_actyon_sports: [{ label: "MEC 4X4", value: "mec_4x4" }],
        rodius: [
          { label: "MEC 4X2", value: "mec_4x2" },
          { label: "AUT 4X2", value: "aut_4x2" },
        ],
        tivoli: [{ label: "AUT 4X2", value: "aut_4x2" }],
      },
      "2017": {
        korando_c: [
          { label: "AUT 4X2", value: "aut_4x2" },
      ...
      "2019": {
        ...
        rexton_sports: [{ label: "AUT 4X4", value: "aut_4x4" }],
      },
      "2020": {
        korando_c: [
          { label: "MEC 4X2", value: "mec_4x2" },
      ...
      "2021": {
        ...
        rexton_g4: [{ label: "AUT 4X4", value: "aut_4x4" }],
        rexton_sports: [
          { label: "MEC 4X4", value: "mec_4x4" },
          { label: "AUT 4X4", value: "aut_4x4" },
        ],
      ...
      "2022": {
        ...
        korando_ii: [{ label: "AUT 4X2", value: "aut_4x2" }],
      },
      "2023": {
        tivoli: [
          { label: "MEC 4X2", value: "mec_4x2" },
        ...
        rexton_sports: [{ label: "AUT 4X4", value: "aut_4x4" }],
        korando_ii: [{ label: "AUT 4X2", value: "aut_4x2" }],
        torres: [{ label: "AUT 4X4", value: "aut_4x4" }],
      },
    },
  };
  ...
  React.useEffect(() => {}, [brand, model, family, transmission, fuel, line]);
      ...
      <div className="w-full p-10 sm:w-96 sm:mx-auto lg:w-[500px] 2xl:w-[600px]">
        <Form labelCol={{ span: 4 }} layout="vertical">
          ...
          >
            <Select
              value={transmission}
              options={transmissions?.[brand]?.[model]?.[family]}
              onChange={(value) => handleTransmissionChange(value)}
            />
          </Form.Item>
          <Form.Item<FieldType>
            label="Combustible"
          ...
          >
            <Select
              value={fuel}
              options={fuels?.[brand]?.[model]?.[family]?.[transmission]}
          ...
          >
            <Select
              value={line}
              options={
                lines?.[brand]?.[model]?.[family]?.[transmission]?.[fuel]
              }
              onChange={setLine}
            />
          </Form.Item>
