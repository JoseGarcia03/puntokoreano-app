    ...
    return (
        <div className="px-5 mb-10 max-w-[1280px] lg:mx-auto lg:px-10">
            ...
            <section className="mt-5 lg:flex lg:gap-5 2xl:w-[1280px] 2xl:mx-auto ">
                <ImagesView />
                <div>
                    <h1 className="font-bold text-xl mb-2 lg:text-2xl">Filtro de aire de alto flujo</h1>
                    ...
                    <button className="bg-[#E2060F] hover:bg-[#001529] transition-[background-color] duration-300 text-white block w-full py-2 rounded-full font-semibold text-base mt-2">Comprar ahora</button>
